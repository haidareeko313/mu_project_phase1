...
export default function Edit({ item }) {
  ...
  return (
    <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-100">Edit Menu Item</h2>}>
        ...
        <div>
          ...
          {item.image_url && (
            <img
              src={item.image_url}
              alt={item.name}
              className="h-20 w-28 object-cover rounded border border-slate-700 mb-2"
            />
          )}
          <input
            type="file"
